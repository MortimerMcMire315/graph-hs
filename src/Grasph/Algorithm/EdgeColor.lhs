...
> module Grasph.Algorithm.EdgeColor
> (deltaPlusOneColor, isValidColoring) where
>
> import Grasph.Graph (Edge (..), Graph, vertices, edges,
>                           incidentEdges, degreeMap, highestDegree, adjacencyList,
>                           modifyEdgeUnsafe, setEdgeColor)
> import Grasph.Algorithm.DFS (getComponents)
...
> isValidColoring g = all (noneRepeated . colorsAt) (vertices g)
